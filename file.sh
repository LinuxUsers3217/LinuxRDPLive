...
# Define the root directory to /home/ubuntu.
# We can only write in /home/ubuntu and /tmp in the ubuntu/RDP.
...
case $input in
    ...
    2)
    wget --tries=$max_retries --timeout=$timeout --no-hsts -O /tmp/rootfs.tar.gz \
    "https://www.dropbox.com/scl/fi/4lptfz2ixztzjb6zq9lee/proxmox_beta_ps4linux.tar.xz?rlkey=271jtogx1fsgq5q3jqz618kf2&dl=1"
